...
@section('id_nav', 'faq_nav')

@section('content')
    <section class="bg-white dark:bg-gray-800 mt-10">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            <x-jumbroton :page="'FAQ'" :url="'faq'" class="mt-2" />
            <div class="grid md:grid-cols-1 gap-8">
                <x-form-meta :url="'meta-faq.update'" :meta="$meta" />
            </div>
            <!-- Modal toggle -->
                        ...
                        <form class="p-4 md:p-5" action="{{ route('faq.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid gap-4 mb-4 grid-cols-2">
                                <div class="col-span-2">
                                    <x-label :text="'Pertanyaan'" />
                                    <x-input-text :name="'question'" :placeholder="'cth: Bagaimana cara menghubungi Kami?'" />
                                </div>
                                <div class="col-span-2">
                                    <x-label :text="'Jawaban'" />
                                    <x-textarea-summernote :name="'answer'" />
                                </div>
                            </div>
                            <x-button />
                        </form>
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <form action="{{ route('faq.destroy', ['id' => $value->id]) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5">
                        <form class="p-4 md:p-5" action="{{ route('faq.update') }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="grid gap-4 mb-4 grid-cols-2">
                                <div class="col-span-2">
                                    ...
                                    <x-input-text :name="'question'" :value="$value->question" :placeholder="'cth: Bagaimana cara menghubungi Kami?'" />
                                </div>
                                <div class="col-span-2">
                                    <x-label :text="'Jawaban'" />
                                    <x-textarea-summernote :name="'answer'" :value="$value->answer" />
                                </div>
                            </div>
                            <x-button-update />
                        </form>
